...
def train_logistic_regression(X_train, y_train, X_test):
    ...
    return fit_and_predict(model=model, X_train=X_train, y_train=y_train, X_test=X_test)
...
def train_models(X_train, y_train, X_test):
    ...
    logistic_results = train_logistic_regression(X_train, y_train, X_test)

    random_forest_results = train_random_forest(X_train, y_train, X_test)
